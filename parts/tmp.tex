...
\begin{figure}[h]
    \centering
    \addletter{140}{a} \phantom{4}
    \includegraphics{fig-ai/crossed-aod.pdf}
    \hfill
    \addletter{140}{b} \phantom{4}
    \includegraphics{fig-ai/blank.pdf}
    \newline
    \phantom{42}
    \newline
    \addletter{100}{c} \phantom{4}
    \includegraphics{fig-ai/blank2.pdf}
    \caption{Эта фигура про то как управлять \cancel{миром} двумя AOD: как через ЛинРег восстановить crosstalk matrix для атомов и для камеры}
    %\label{fig:}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{
        \textbf{Антенны.}
        Тут ещё два графика про fidelity RF и MW флипов.
    }
    \label{fig:RFMW}
\end{figure}
