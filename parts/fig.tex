...
\begin{figure}[h!]
    ...
    \caption{
        (a) Histogram of the normalized fluorescence signal after loading to the MOT, showing clear quantized peaks corresponding to integer atom numbers. The solid red line is a multi-Gaussian fit to the observed distribution. 
