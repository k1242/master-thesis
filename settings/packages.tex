...
\hypersetup{
    pdftitle={Tools for 2D Fermi-Hubbard Simulation: State Preparation and Spin-Resolved Imaging},
    pdfauthor={Khoruzhii, Kirill},
    pdfsubject={Master's Thesis},
    pdfkeywords={Fermi-Hubbard, quantum simulation, optical tweezers, ultracold atoms, many-body physics},
    pdfcreator={LaTeX}
}
